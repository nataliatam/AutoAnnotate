...
#-----------------------------------------------------------------------
# auth.py
# Adapted from application written by Bob Dondero
...
GOOGLE_CLIENT_ID=('68420104889-qcml7ssn7328f0qe31qvkdofae5nf93v.'+
                  'apps.googleusercontent.com')
GOOGLE_CLIENT_SECRET='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'
